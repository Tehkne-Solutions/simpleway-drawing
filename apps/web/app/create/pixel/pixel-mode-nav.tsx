...
export function PixelModeNav({ active }: { active: PixelMode }) {
  return (
    <nav className="pixel-mode-nav" aria-label="Modos do Atelier da Síntese">
      ...
      <span className="secondary link-button is-disabled" aria-disabled="true">03 · Tile Lab</span>
