...
export default async function FormPage({ searchParams }: { searchParams: Promise<{ exercise?: string; returnTo?: string }> }) {
  ...
  return (
    <main className="flow-shell">
      <section className="flow-card form-card">
        <FormClient exercises={exercises} localUiOnly={localUiOnly} initialExerciseKey={initialExerciseKey} returnTo={returnTo} />
      </section>
    </main>
  );
}
